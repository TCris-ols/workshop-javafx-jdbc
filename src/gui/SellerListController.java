...
public class SellerListController implements Initializable, DataChangeListener {
	...
	private SellerFormController controller;
	private SellerService service;
	private ObservableList<Seller> obslist;
	private Seller obj = new Seller();
	...
	private void initializeNodesSeller() {
		...
		Utils.formatTableColumnDate(tbColumnBDate, "dd/MM/yyyy");
		...
		tbColumnBDate.setStyle( "-fx-alignment: CENTER;"); 
		tbColumnBSalary.setStyle( "-fx-alignment: CENTER-RIGHT;");
		tableColumnEDIT.setStyle( "-fx-alignment: CENTER;");
		tableColumnREMOVE.setStyle( "-fx-alignment: CENTER;");
		
		Utils.formatTableColumnDouble(tbColumnBSalary, 2);
	...
	private void createDialogForm(Seller obj, String absoluteName, Stage parentStage) {
		try {
			...
			controller.loadAssociatedeObject();
