...
public class SellerFormController implements Initializable {
	...
	/*
	 * @FXML private void onCbDepartmentAction(ActionEvent event) { // Department
	 * //department = cbDepartment.getSelectionModel().getSelectedItem();
	 * System.out.println("OK"); // cbDepartment.getValue().getName(); }
	 */
	...
	public Seller getFormData() {
	  ...
	  if (dpBirthDate.getValue() == null) { exception.addError("birthDate",
	  "Field can't be empty"); } else { Instant instant =
	  Instant.from(dpBirthDate.getValue().atStartOfDay(ZoneId.systemDefault()));
	  ...
	  obj.setBaseSalary(Utils.tryPaserToDouble(txtBaseSalary.getText()));
	...
	private void setErrorMessages(Map<String, String> errors) {
		Set<String> fields = errors.keySet();
			...
			lblErrorBSalary.setText((fields.contains("baseSalary") ? errors.get("baseSalary") : ""));
	...
	public void loadAssociatedeObject() {
		if (depservice == null) {
			throw new IllegalStateException("Service was null");
		}
